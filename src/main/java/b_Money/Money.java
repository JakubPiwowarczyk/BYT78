...
public class Money implements Comparable {
	...
	public Boolean equals(Money other) {
		int otherAmountInThisCurrency = other.currency.valueInThisCurrency(other.amount, currency);
		return amount == otherAmountInThisCurrency;
	}
	...
	public Money add(Money other) {
		...
		int otherAmountInThisCurrency = other.currency.valueInThisCurrency(other.amount, currency);
		int newAmount = amount + otherAmountInThisCurrency;
	...
	public int compareTo(Object other) {
		...
		int thisUniversalValue = universalValue();
		int otherUniversalValue = otherMoney.universalValue();
